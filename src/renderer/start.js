            ...
            if (!err) {
                ...
                if (meihangarray1.length >= 2) {
                    ...
                    for (var key in meihangarray1) {
                        if (
                            (mykaishi = meihangarray1[key].indexOf(
                                "ProgID:"
                            )) >= 0
                        ) {
                    ...
                    if (usefuloutput1.length > 0) {
                        ...
                        for (key in usefuloutput1) {
                            if (
                                (myjiewei = usefuloutput1[key].indexOf(
                                    "CLSID:"
                                )) >= 0
                            ) {
                                myserverlist.push(
        ...
        function mycallback2(err, data, stderr) {
            ...
            if (!err) {
                ...
                if (usefuloutput.length > 0) {
                    ...
                    $("#myfreetime").text(
                        Math.round(
                            (my空闲时间次数 / allrefreshcishu) * 100 * 100
                        ) /
                            100 +
                            "%"
                    );
                    ...
                    $("#my1floortime").text(
                        Math.round(
                            (my停靠1层次数 / allrefreshcishu) * 100 * 100
                        ) /
                            100 +
                            "%"
                    );
                    $("#my2floortime").text(
                        Math.round(
                            (my停靠2层次数 / allrefreshcishu) * 100 * 100
                        ) /
                            100 +
                            "%"
                    );
                    $("#my3floortime").text(
                        Math.round(
                            (my停靠3层次数 / allrefreshcishu) * 100 * 100
                        ) /
                            100 +
                            "%"
                    );
                    $("#my4floortime").text(
                        Math.round(
                            (my停靠4层次数 / allrefreshcishu) * 100 * 100
                        ) /
                            100 +
                            "%"
                    );
                    ...
                    $("#myopentime").text(
                        Math.round((my开门次数 / allrefreshcishu) * 100 * 100) /
                            100 +
                            "%"
                    );
                    $("#myclosetime").text(
                        Math.round((my关门次数 / allrefreshcishu) * 100 * 100) /
                            100 +
                            "%"
                    );
                } else {
